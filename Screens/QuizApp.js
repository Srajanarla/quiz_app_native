...
//   const handleNewQuestionChange = (name, value, index) => {
//     if (index !== undefined) {
...
//                   <Text style={styles.questionCount}>Question {currentQuestionIndex + 1}/{questions.length}</Text>
...
//       {view === 'create' && (
//         <ScrollView style={styles.createQuestionSection}>
//           <Text style={styles.header}>Create a New Question</Text>
//           <TextInput
//             style={styles.input}
//             placeholder="Enter question"
//             value={newQuestion.question}
//             onChangeText={(text) => handleNewQuestionChange('question', text)}
//           />
...
//             onChangeText={(text) => handleNewQuestionChange('correct', text)}
//           />
//           <Button title="Add Question" onPress={handleAddQuestion} />
//           <Button title="Cancel" onPress={() => setView('quiz')} />
//         </ScrollView>
//       )}

//       {view === 'edit' && selectedQuestion && (
//         <ScrollView style={styles.editQuestionSection}>
